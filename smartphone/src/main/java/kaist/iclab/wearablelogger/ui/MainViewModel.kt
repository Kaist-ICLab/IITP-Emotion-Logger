...
class MainViewModel(
    ...
    val watchUploadSchedule: StateFlow<Long> = deviceInfoRepository.watchUploadSchedule
    val phoneUploadSchedule: StateFlow<Long> = deviceInfoRepository.phoneUploadSchedule
